...
// Reference: https://github.com/ml-explore/mlx/blob/main/mlx/io.h
// ============================================================================
...
std::unordered_map<std::string, mx::array> NapiToArrayMap(const Napi::Value& value) {
  ...
  if (value.IsObject() && !value.IsArray()) {
    ...
    for (uint32_t i = 0; i < keys.Length(); i++) {
      ...
      result.emplace(key, NapiToArray(obj.Get(key)));
    }
  }
  return result;
}
...
Napi::Value StringMapToNapi(Napi::Env env,
  ...
  try {
    ...
    if (!info[0].IsString()) {
      throw Napi::TypeError::New(env,
                                 "save_safetensors() first argument must be a file path string");
    }
    if (!info[1].IsObject()) {
      throw Napi::TypeError::New(env,
                                 "save_safetensors() second argument must be an object of arrays");
    }
...
Napi::Object Init(Napi::Env env, Napi::Object exports) {
  ...
  // I/O Functions (manually defined)
  exports.Set("load", Napi::Function::New(env, Wrap_load));
  exports.Set("load_safetensors", Napi::Function::New(env, Wrap_load_safetensors));
  exports.Set("save", Napi::Function::New(env, Wrap_save));
  exports.Set("save_safetensors", Napi::Function::New(env, Wrap_save_safetensors));
